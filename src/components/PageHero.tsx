...
export function PageHero({
  ...
  return (
    <section className="relative overflow-hidden bg-warm-panel pb-12 pt-24 text-white xs:pb-14 sm:pb-16 sm:pt-28 md:pb-20 md:pt-32">
      ...
      <div className="pointer-events-none absolute inset-0 bg-grid-faint bg-[size:24px_24px] opacity-25 sm:bg-[size:28px_28px]" />
      ...
      <div className="container-site relative animate-fade-up">
        ...
        {description ? (
          <p className="mt-4 max-w-2xl text-sm leading-relaxed text-on-dark-muted xs:text-base sm:mt-5 sm:text-lg">
            {description}
          </p>
        ) : null}
        {children}
